...
use Firmen\Contact;
use Firmen\FirmaTitle;
use Firmen\Profession;
use Firmen\JobPraktikum;
use Auth;
...
class PraktikumController extends Controller
{
    ...
    public function create()
    {
        ...
        // $states = State::where('id',$cities->state_id)->first();
        $states = State::all();
        $cities = City::all();
        $statuses = Status::all();
        $jobs = Job::all();
        $bdepartments = Bdepartment::all();
        $firma_titles = FirmaTitle::all();
        return view('praktikum-form',['states'=>$states,'cities'=>$cities,'statuses'=>$statuses,'jobs'=>$jobs,'bdepartments'=>$bdepartments,'firma_titles'=>$firma_titles,'profession'=>$profession]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $praktikum->firma_title_id = $request->firma_title_id;
        $praktikum->profession_id = $request->profession_id;
        ...
        foreach($request->job_id as $item) {
            $bridge = new JobPraktikum();
            $bridge->praktikum_id = $praktikum->id;
            $bridge->job_id = $item;
            $bridge->save();
        }
    ...
    public function show($id)
    {
        ...
        return view('view',compact('praktikum'));
    }
    ...
    public function edit($id)
    {
        ...
        'jobs'=>$jobs,'bdepartments'=>$bdepartments,'firma_titles'=>$firma_titles,'profession'=>$profession,'user'=>$user]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        JobPraktikum::where('praktikum_id',$id)->delete();
        foreach($request->job_id as $item) {
            $bridge = new JobPraktikum();
            $bridge->praktikum_id = $praktikum->id;
            $bridge->job_id = $item;
